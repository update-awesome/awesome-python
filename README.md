...
* <code>&nbsp;&nbsp;6713</code> ![](https://img.shields.io/github/last-commit/ajenti/ajenti) [ajenti](https://github.com/ajenti/ajenti) - The admin panel your servers deserve.
...
* <code>&nbsp;&nbsp;4186</code> ![](https://img.shields.io/github/last-commit/python-attrs/attrs) [attrs](https://github.com/python-attrs/attrs) - Replacement for `__init__`, `__eq__`, `__repr__`, etc. boilerplate in class definitions.
...
* Static Type Annotations Generators
    ...
    * <code>&nbsp;&nbsp;3695</code> ![](https://img.shields.io/github/last-commit/google/pytype) [pytype](https://github.com/google/pytype) - Pytype checks and infers types for Python code - without requiring type annotations.
...
* Productivity Tools
    ...
    * <code>&nbsp;&nbsp;3365</code> ![](https://img.shields.io/github/last-commit/tony/tmuxp) [tmuxp](https://github.com/tony/tmuxp) - A <code>&nbsp;24401</code> ![](https://img.shields.io/github/last-commit/tmux/tmux) [tmux](https://github.com/tmux/tmux) session manager.
...
* Profiler
    ...
    * <code>&nbsp;&nbsp;&nbsp;&nbsp;71</code> ![](https://img.shields.io/github/last-commit/fabianp/memory_profiler) [memory_profiler](https://github.com/fabianp/memory_profiler) - Monitor Memory usage of Python code.
...
* <code>&nbsp;&nbsp;4745</code> ![](https://img.shields.io/github/last-commit/martinblech/xmltodict) [xmltodict](https://github.com/martinblech/xmltodict) - Working with XML feel like you are working with JSON.
...
* <code>&nbsp;&nbsp;&nbsp;102</code> ![](https://img.shields.io/github/last-commit/ajkumar25/pygram) [pygram](https://github.com/ajkumar25/pygram) - Instagram-like image filters.
...
* <code>&nbsp;&nbsp;&nbsp;378</code> ![](https://img.shields.io/github/last-commit/jazzband/localshop) [localshop](https://github.com/jazzband/localshop) - Local PyPI server (custom packages and auto-mirroring of pypi).
* <code>&nbsp;&nbsp;2947</code> ![](https://img.shields.io/github/last-commit/pypa/warehouse) [warehouse](https://github.com/pypa/warehouse) - Next generation Python Package Repository (PyPI).

## Penetration Testing

*Frameworks and tools for penetration testing.*

* <code>&nbsp;&nbsp;7522</code> ![](https://img.shields.io/github/last-commit/Manisso/fsociety) [fsociety](https://github.com/Manisso/fsociety) - A Penetration testing framework.
* <code>&nbsp;&nbsp;7506</code> ![](https://img.shields.io/github/last-commit/trustedsec/social-engineer-toolkit) [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) - A toolkit for social engineering.
* <code>&nbsp;23181</code> ![](https://img.shields.io/github/last-commit/sqlmapproject/sqlmap) [sqlmap](https://github.com/sqlmapproject/sqlmap) - Automatic SQL injection and database takeover tool.

## Permissions

*Libraries that allow or deny users access to data or functionality.*

* <code>&nbsp;&nbsp;3168</code> ![](https://img.shields.io/github/last-commit/django-guardian/django-guardian) [django-guardian](https://github.com/django-guardian/django-guardian) - Implementation of per object permissions for Django 1.2+
* <code>&nbsp;&nbsp;1460</code> ![](https://img.shields.io/github/last-commit/dfunckt/django-rules) [django-rules](https://github.com/dfunckt/django-rules) - A tiny but powerful app providing object-level permissions to Django, without requiring a database.

## Processes

*Libraries for starting and communicating with OS processes.*

* <code>&nbsp;&nbsp;1591</code> ![](https://img.shields.io/github/last-commit/amitt001/delegator.py) [delegator.py](https://github.com/amitt001/delegator.py) - [Subprocesses](https://docs.python.org/3/library/subprocess.html) for Humans 2.0.
* [sarge](https://sarge.readthedocs.io/en/latest/) - Yet another wrapper for subprocess.
* <code>&nbsp;&nbsp;6155</code> ![](https://img.shields.io/github/last-commit/amoffat/sh) [sh](https://github.com/amoffat/sh) - A full-fledged subprocess replacement for Python.

## Recommender Systems

*Libraries for building recommender systems.*

* <code>&nbsp;&nbsp;9626</code> ![](https://img.shields.io/github/last-commit/spotify/annoy) [annoy](https://github.com/spotify/annoy) - Approximate Nearest Neighbors in C++/Python optimized for memory usage.
* <code>&nbsp;&nbsp;&nbsp;976</code> ![](https://img.shields.io/github/last-commit/ibayer/fastFM) [fastFM](https://github.com/ibayer/fastFM) - A library for Factorization Machines.
* <code>&nbsp;&nbsp;2740</code> ![](https://img.shields.io/github/last-commit/benfred/implicit) [implicit](https://github.com/benfred/implicit) - A fast Python implementation of collaborative filtering for implicit datasets.
* <code>&nbsp;&nbsp;1544</code> ![](https://img.shields.io/github/last-commit/guestwalk/libffm) [libffm](https://github.com/guestwalk/libffm) - A library for Field-aware Factorization Machine (FFM).
* <code>&nbsp;&nbsp;3987</code> ![](https://img.shields.io/github/last-commit/lyst/lightfm) [lightfm](https://github.com/lyst/lightfm) - A Python implementation of a number of popular recommendation algorithms.
* <code>&nbsp;&nbsp;2701</code> ![](https://img.shields.io/github/last-commit/maciejkula/spotlight) [spotlight](https://github.com/maciejkula/spotlight) - Deep recommender models using PyTorch.
* <code>&nbsp;&nbsp;5317</code> ![](https://img.shields.io/github/last-commit/NicolasHug/Surprise) [Surprise](https://github.com/NicolasHug/Surprise) - A scikit for building and analyzing recommender systems.
* <code>&nbsp;&nbsp;1183</code> ![](https://img.shields.io/github/last-commit/jfkirk/tensorrec) [tensorrec](https://github.com/jfkirk/tensorrec) - A Recommendation Engine Framework in TensorFlow.
 ...
 * <code>&nbsp;&nbsp;1301</code> ![](https://img.shields.io/github/last-commit/python-rope/rope) [Rope](https://github.com/python-rope/rope) -  Rope is a python refactoring library.
...
* Flask
    * <code>&nbsp;&nbsp;6457</code> ![](https://img.shields.io/github/last-commit/pyeve/eve) [eve](https://github.com/pyeve/eve) - REST API framework powered by Flask, MongoDB and good intentions.
    * <code>&nbsp;&nbsp;1312</code> ![](https://img.shields.io/github/last-commit/flask-api/flask-api) [flask-api](https://github.com/flask-api/flask-api) - Browsable Web APIs for Flask.
    * <code>&nbsp;&nbsp;6335</code> ![](https://img.shields.io/github/last-commit/flask-restful/flask-restful) [flask-restful](https://github.com/flask-restful/flask-restful) - Quickly building REST APIs for Flask.
* Pyramid
    * <code>&nbsp;&nbsp;&nbsp;374</code> ![](https://img.shields.io/github/last-commit/Cornices/cornice) [cornice](https://github.com/Cornices/cornice) - A RESTful framework for Pyramid.
* Framework agnostic
    * <code>&nbsp;&nbsp;5602</code> ![](https://img.shields.io/github/last-commit/encode/apistar) [apistar](https://github.com/encode/apistar) - A smart Web API framework, designed for Python 3.
    * <code>&nbsp;&nbsp;8745</code> ![](https://img.shields.io/github/last-commit/falconry/falcon) [falcon](https://github.com/falconry/falcon) - A high-performance framework for building cloud APIs and web app backends.
    * <code>&nbsp;44033</code> ![](https://img.shields.io/github/last-commit/tiangolo/fastapi) [fastapi](https://github.com/tiangolo/fastapi) - A modern, fast, web framework for building APIs with Python 3.6+ based on standard Python type hints.
    * <code>&nbsp;&nbsp;6610</code> ![](https://img.shields.io/github/last-commit/hugapi/hug) [hug](https://github.com/hugapi/hug) - A Python 3 framework for cleanly exposing APIs.
    * <code>&nbsp;&nbsp;1825</code> ![](https://img.shields.io/github/last-commit/jeffknupp/sandman2) [sandman2](https://github.com/jeffknupp/sandman2) - Automated REST APIs for existing database-driven systems.
    * <code>&nbsp;16014</code> ![](https://img.shields.io/github/last-commit/huge-success/sanic) [sanic](https://github.com/huge-success/sanic) - A Python 3.6+ web server and web framework that's written to go fast.
...
* <code>&nbsp;14999</code> ![](https://img.shields.io/github/last-commit/AtsushiSakai/PythonRobotics) [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) - This is a compilation of various robotics algorithms with visualizations.
...
* <code>&nbsp;&nbsp;1152</code> ![](https://img.shields.io/github/last-commit/tomerfiliba/rpyc) [RPyC](https://github.com/tomerfiliba/rpyc) (Remote Python Call) - A transparent and symmetric RPC library for Python
* <code>&nbsp;&nbsp;2918</code> ![](https://img.shields.io/github/last-commit/0rpc/zerorpc-python) [zeroRPC](https://github.com/0rpc/zerorpc-python) - zerorpc is a flexible RPC implementation based on [ZeroMQ](http://zeromq.org/) and [MessagePack](http://msgpack.org/).

## Science

*Libraries for scientific computing. Also see <code>&nbsp;&nbsp;&nbsp;168</code> ![](https://img.shields.io/github/last-commit/TomNicholas/Python-for-Scientists) [Python-for-Scientists](https://github.com/TomNicholas/Python-for-Scientists).*

* [astropy](http://www.astropy.org/) - A community Python library for Astronomy.
* <code>&nbsp;&nbsp;&nbsp;872</code> ![](https://img.shields.io/github/last-commit/chapmanb/bcbio-nextgen) [bcbio-nextgen](https://github.com/chapmanb/bcbio-nextgen) - Providing best-practice pipelines for fully automated high throughput sequencing analysis.
* <code>&nbsp;&nbsp;&nbsp;541</code> ![](https://img.shields.io/github/last-commit/chapmanb/bcbb) [bccb](https://github.com/chapmanb/bcbb) - Collection of useful code related to biological analysis.
* [Biopython](http://biopython.org/wiki/Main_Page) - Biopython is a set of freely available tools for biological computation.
* [cclib](http://cclib.github.io/) - A library for parsing and interpreting the results of computational chemistry packages.
* [Colour](http://colour-science.org/) - Implementing a comprehensive number of colour theory transformations and algorithms.
* <code>&nbsp;&nbsp;1574</code> ![](https://img.shields.io/github/last-commit/benedekrozemberczki/karateclub) [Karate Club](https://github.com/benedekrozemberczki/karateclub) - Unsupervised machine learning toolbox for graph structured data.
* [NetworkX](https://networkx.github.io/) - A high-productivity software for complex networks.
* [NIPY](http://nipy.org) - A collection of neuroimaging toolkits.
* [NumPy](http://www.numpy.org/) - A fundamental package for scientific computing with Python.
* <code>&nbsp;&nbsp;&nbsp;886</code> ![](https://img.shields.io/github/last-commit/obspy/obspy) [ObsPy](https://github.com/obspy/obspy/wiki/) - A Python toolbox for seismology.
* [Open Babel](http://openbabel.org/wiki/Main_Page) - A chemical toolbox designed to speak the many languages of chemical data.
* [PyDy](http://www.pydy.org/) - Short for Python Dynamics, used to assist with workflow in the modeling of dynamic motion.
* <code>&nbsp;&nbsp;6506</code> ![](https://img.shields.io/github/last-commit/pymc-devs/pymc3) [PyMC](https://github.com/pymc-devs/pymc3) - Markov Chain Monte Carlo sampling toolkit.
* [QuTiP](http://qutip.org/) - Quantum Toolbox in Python.
* [RDKit](http://www.rdkit.org/) - Cheminformatics and Machine Learning Software.
* [SciPy](https://www.scipy.org/) - A Python-based ecosystem of open-source software for mathematics, science, and engineering.
* [SimPy](https://gitlab.com/team-simpy/simpy) -  A process-based discrete-event simulation framework.
* <code>&nbsp;&nbsp;7281</code> ![](https://img.shields.io/github/last-commit/statsmodels/statsmodels) [statsmodels](https://github.com/statsmodels/statsmodels) - Statistical modeling and econometrics in Python.
* <code>&nbsp;&nbsp;9049</code> ![](https://img.shields.io/github/last-commit/sympy/sympy) [SymPy](https://github.com/sympy/sympy) - A Python library for symbolic mathematics.
* <code>&nbsp;15060</code> ![](https://img.shields.io/github/last-commit/quantopian/zipline) [Zipline](https://github.com/quantopian/zipline) - A Pythonic algorithmic trading library.

## Search

*Libraries and software for indexing and performing search queries on data.*

* <code>&nbsp;&nbsp;3288</code> ![](https://img.shields.io/github/last-commit/django-haystack/django-haystack) [django-haystack](https://github.com/django-haystack/django-haystack) - Modular search for Django.
* <code>&nbsp;&nbsp;3454</code> ![](https://img.shields.io/github/last-commit/elastic/elasticsearch-dsl-py) [elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - The official high-level Python client for Elasticsearch.
* [elasticsearch-py](https://www.elastic.co/guide/en/elasticsearch/client/python-api/current/index.html) - The official low-level Python client for [Elasticsearch](https://www.elastic.co/products/elasticsearch).
* <code>&nbsp;&nbsp;&nbsp;616</code> ![](https://img.shields.io/github/last-commit/django-haystack/pysolr) [pysolr](https://github.com/django-haystack/pysolr) - A lightweight Python wrapper for [Apache Solr](https://lucene.apache.org/solr/).
...
* <code>&nbsp;&nbsp;6041</code> ![](https://img.shields.io/github/last-commit/marshmallow-code/marshmallow) [marshmallow](https://github.com/marshmallow-code/marshmallow) - A lightweight library for converting complex objects to and from simple Python datatypes.
* <code>&nbsp;&nbsp;&nbsp;518</code> ![](https://img.shields.io/github/last-commit/TkTech/pysimdjson) [pysimdjson](https://github.com/TkTech/pysimdjson) - A Python bindings for <code>&nbsp;15461</code> ![](https://img.shields.io/github/last-commit/lemire/simdjson) [simdjson](https://github.com/lemire/simdjson).
* <code>&nbsp;&nbsp;&nbsp;447</code> ![](https://img.shields.io/github/last-commit/python-rapidjson/python-rapidjson) [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) - A Python wrapper around <code>&nbsp;11933</code> ![](https://img.shields.io/github/last-commit/Tencent/rapidjson) [RapidJSON](https://github.com/Tencent/rapidjson).
* <code>&nbsp;&nbsp;3647</code> ![](https://img.shields.io/github/last-commit/esnme/ultrajson) [ultrajson](https://github.com/esnme/ultrajson) - A fast JSON decoder and encoder written in C with Python bindings.

## Serverless Frameworks

*Frameworks for developing serverless Python code.*

* <code>&nbsp;&nbsp;1363</code> ![](https://img.shields.io/github/last-commit/nficano/python-lambda) [python-lambda](https://github.com/nficano/python-lambda) - A toolkit for developing and deploying Python code in AWS Lambda.
* <code>&nbsp;11851</code> ![](https://img.shields.io/github/last-commit/Miserlou/Zappa) [Zappa](https://github.com/Miserlou/Zappa) - A tool for deploying WSGI applications on AWS Lambda and API Gateway.

## Shell

*Shells based on Python.*

* <code>&nbsp;&nbsp;5783</code> ![](https://img.shields.io/github/last-commit/xonsh/xonsh) [xonsh](https://github.com/xonsh/xonsh/) - A Python-powered, cross-platform, Unix-gazing shell language and command prompt.
...
* General
    * <code>&nbsp;&nbsp;4104</code> ![](https://img.shields.io/github/last-commit/jazzband/tablib) [tablib](https://github.com/jazzband/tablib) - A module for Tabular Datasets in XLS, CSV, JSON, YAML.
* Office
    * <code>&nbsp;&nbsp;1233</code> ![](https://img.shields.io/github/last-commit/elapouya/python-docx-template) [docxtpl](https://github.com/elapouya/python-docx-template) - Editing a docx document by jinja2 template
    * [openpyxl](https://openpyxl.readthedocs.io/en/stable/) - A library for reading and writing Excel 2010 xlsx/xlsm/xltx/xltm files.
    * <code>&nbsp;&nbsp;1010</code> ![](https://img.shields.io/github/last-commit/pyexcel/pyexcel) [pyexcel](https://github.com/pyexcel/pyexcel) - Providing one API for reading, manipulating and writing csv, ods, xls, xlsx and xlsm files.
    * <code>&nbsp;&nbsp;3057</code> ![](https://img.shields.io/github/last-commit/python-openxml/python-docx) [python-docx](https://github.com/python-openxml/python-docx) - Reads, queries and modifies Microsoft Word 2007/2008 docx files.
    * <code>&nbsp;&nbsp;1503</code> ![](https://img.shields.io/github/last-commit/scanny/python-pptx) [python-pptx](https://github.com/scanny/python-pptx) - Python library for creating and updating PowerPoint (.pptx) files.
    * <code>&nbsp;&nbsp;2266</code> ![](https://img.shields.io/github/last-commit/unoconv/unoconv) [unoconv](https://github.com/unoconv/unoconv) - Convert between any document format supported by LibreOffice/OpenOffice.
    * <code>&nbsp;&nbsp;2877</code> ![](https://img.shields.io/github/last-commit/jmcnamara/XlsxWriter) [XlsxWriter](https://github.com/jmcnamara/XlsxWriter) - A Python module for creating Excel .xlsx files.
    * <code>&nbsp;&nbsp;2285</code> ![](https://img.shields.io/github/last-commit/ZoomerAnalytics/xlwings) [xlwings](https://github.com/ZoomerAnalytics/xlwings) - A BSD-licensed library that makes it easy to call Python from Excel and vice versa.
    * <code>&nbsp;&nbsp;&nbsp;989</code> ![](https://img.shields.io/github/last-commit/python-excel/xlwt) [xlwt](https://github.com/python-excel/xlwt) / <code>&nbsp;&nbsp;1975</code> ![](https://img.shields.io/github/last-commit/python-excel/xlrd) [xlrd](https://github.com/python-excel/xlrd) - Writing and reading data and formatting information from Excel files.
* PDF
    * <code>&nbsp;&nbsp;4788</code> ![](https://img.shields.io/github/last-commit/euske/pdfminer) [PDFMiner](https://github.com/euske/pdfminer) - A tool for extracting information from PDF documents.
    * <code>&nbsp;&nbsp;4176</code> ![](https://img.shields.io/github/last-commit/mstamy2/PyPDF2) [PyPDF2](https://github.com/mstamy2/PyPDF2) - A library capable of splitting, merging and transforming PDF pages.
    * [ReportLab](https://www.reportlab.com/opensource/) - Allowing Rapid creation of rich PDF documents.
* Markdown
    * <code>&nbsp;&nbsp;2049</code> ![](https://img.shields.io/github/last-commit/lepture/mistune) [Mistune](https://github.com/lepture/mistune) - Fastest and full featured pure Python parsers of Markdown.
    * <code>&nbsp;&nbsp;2839</code> ![](https://img.shields.io/github/last-commit/waylan/Python-Markdown) [Python-Markdown](https://github.com/waylan/Python-Markdown) - A Python implementation of John Gruber’s Markdown.
* YAML
    * [PyYAML](http://pyyaml.org/) - YAML implementations for Python.
* CSV
    * <code>&nbsp;&nbsp;4932</code> ![](https://img.shields.io/github/last-commit/wireservice/csvkit) [csvkit](https://github.com/wireservice/csvkit) - Utilities for converting to and working with CSV.
* Archive
    * <code>&nbsp;&nbsp;&nbsp;400</code> ![](https://img.shields.io/github/last-commit/mitsuhiko/unp) [unp](https://github.com/mitsuhiko/unp) - A command line tool that can unpack archives easily.

## Static Site Generator

*Static site generator is a software that takes some text + templates as input and produces HTML files on the output.*

* <code>&nbsp;&nbsp;3558</code> ![](https://img.shields.io/github/last-commit/lektor/lektor) [lektor](https://github.com/lektor/lektor) - An easy to use static CMS and blog engine.
* <code>&nbsp;13996</code> ![](https://img.shields.io/github/last-commit/mkdocs/mkdocs) [mkdocs](https://github.com/mkdocs/mkdocs/) - Markdown friendly documentation generator.
* <code>&nbsp;&nbsp;1607</code> ![](https://img.shields.io/github/last-commit/sunainapai/makesite) [makesite](https://github.com/sunainapai/makesite) - Simple, lightweight, and magic-free static site/blog generator (< 130 lines).
* <code>&nbsp;&nbsp;2282</code> ![](https://img.shields.io/github/last-commit/getnikola/nikola) [nikola](https://github.com/getnikola/nikola) - A static website and blog generator.
* <code>&nbsp;10891</code> ![](https://img.shields.io/github/last-commit/getpelican/pelican) [pelican](https://github.com/getpelican/pelican) - Static site generator that supports Markdown and reST syntax.

## Tagging

*Libraries for tagging items.*

* <code>&nbsp;&nbsp;2829</code> ![](https://img.shields.io/github/last-commit/jazzband/django-taggit) [django-taggit](https://github.com/jazzband/django-taggit) - Simple tagging for Django.
...
* <code>&nbsp;&nbsp;3022</code> ![](https://img.shields.io/github/last-commit/Bogdanp/dramatiq) [dramatiq](https://github.com/Bogdanp/dramatiq) - A fast and reliable background task processing library for Python 3.
* <code>&nbsp;&nbsp;3921</code> ![](https://img.shields.io/github/last-commit/coleifer/huey) [huey](https://github.com/coleifer/huey) - Little multi-threaded task queue.
* <code>&nbsp;&nbsp;&nbsp;864</code> ![](https://img.shields.io/github/last-commit/pricingassistant/mrq) [mrq](https://github.com/pricingassistant/mrq) - A distributed worker task queue in Python using Redis & gevent.
* <code>&nbsp;&nbsp;8236</code> ![](https://img.shields.io/github/last-commit/rq/rq) [rq](https://github.com/rq/rq) - Simple job queues for Python.
...
* <code>&nbsp;&nbsp;8448</code> ![](https://img.shields.io/github/last-commit/pallets/jinja) [Jinja2](https://github.com/pallets/jinja) - A modern and designer friendly templating language.
...
* Testing Frameworks
    * <code>&nbsp;&nbsp;5789</code> ![](https://img.shields.io/github/last-commit/HypothesisWorks/hypothesis) [hypothesis](https://github.com/HypothesisWorks/hypothesis) - Hypothesis is an advanced Quickcheck style property based testing library.
    * <code>&nbsp;&nbsp;&nbsp;705</code> ![](https://img.shields.io/github/last-commit/nose-devs/nose2) [nose2](https://github.com/nose-devs/nose2) - The successor to `nose`, based on `unittest2.
    * [pytest](https://docs.pytest.org/en/latest/) - A mature full-featured Python testing tool.
    * <code>&nbsp;&nbsp;6865</code> ![](https://img.shields.io/github/last-commit/robotframework/robotframework) [Robot Framework](https://github.com/robotframework/robotframework) - A generic test automation framework.
    * [unittest](https://docs.python.org/3/library/unittest.html) - (Python standard library) Unit testing framework.
* Test Runners
    * <code>&nbsp;&nbsp;&nbsp;734</code> ![](https://img.shields.io/github/last-commit/CleanCut/green) [green](https://github.com/CleanCut/green) - A clean, colorful test runner.
    * [mamba](http://nestorsalceda.github.io/mamba/) - The definitive testing tool for Python. Born under the banner of BDD.
    * [tox](https://tox.readthedocs.io/en/latest/) - Auto builds and tests distributions in multiple Python versions
* GUI / Web Testing
    * <code>&nbsp;18647</code> ![](https://img.shields.io/github/last-commit/locustio/locust) [locust](https://github.com/locustio/locust) - Scalable user load testing tool written in Python.
    * <code>&nbsp;&nbsp;6475</code> ![](https://img.shields.io/github/last-commit/asweigart/pyautogui) [PyAutoGUI](https://github.com/asweigart/pyautogui) - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
    * <code>&nbsp;&nbsp;1220</code> ![](https://img.shields.io/github/last-commit/kiwicom/schemathesis) [Schemathesis](https://github.com/kiwicom/schemathesis) - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
    * [Selenium](https://pypi.org/project/selenium/) - Python bindings for [Selenium](http://www.seleniumhq.org/) WebDriver.
    * <code>&nbsp;&nbsp;1727</code> ![](https://img.shields.io/github/last-commit/seatgeek/sixpack) [sixpack](https://github.com/seatgeek/sixpack) - A language-agnostic A/B Testing framework.
    * <code>&nbsp;&nbsp;2500</code> ![](https://img.shields.io/github/last-commit/cobrateam/splinter) [splinter](https://github.com/cobrateam/splinter) - Open source tool for testing web applications.
* Mock
    * [doublex](https://pypi.org/project/doublex/) - Powerful test doubles framework for Python.
    * <code>&nbsp;&nbsp;3228</code> ![](https://img.shields.io/github/last-commit/spulec/freezegun) [freezegun](https://github.com/spulec/freezegun) - Travel through time by mocking the datetime module.
    * <code>&nbsp;&nbsp;&nbsp;441</code> ![](https://img.shields.io/github/last-commit/patrys/httmock) [httmock](https://github.com/patrys/httmock) - A mocking library for requests for Python 2.6+ and 3.2+.
    * <code>&nbsp;&nbsp;1948</code> ![](https://img.shields.io/github/last-commit/gabrielfalcao/HTTPretty) [httpretty](https://github.com/gabrielfalcao/HTTPretty) - HTTP request mock tool for Python.
    * [mock](https://docs.python.org/3/library/unittest.mock.html) - (Python standard library) A mocking and patching library.
    * <code>&nbsp;&nbsp;&nbsp;229</code> ![](https://img.shields.io/github/last-commit/mindflayer/python-mocket) [mocket](https://github.com/mindflayer/python-mocket) - A socket mock framework with gevent/asyncio/SSL support.
    * <code>&nbsp;&nbsp;3533</code> ![](https://img.shields.io/github/last-commit/getsentry/responses) [responses](https://github.com/getsentry/responses) - A utility library for mocking out the requests Python library.
    * <code>&nbsp;&nbsp;2211</code> ![](https://img.shields.io/github/last-commit/kevin1024/vcrpy) [VCR.py](https://github.com/kevin1024/vcrpy) - Record and replay HTTP interactions on your tests.
* Object Factories
    * <code>&nbsp;&nbsp;2800</code> ![](https://img.shields.io/github/last-commit/FactoryBoy/factory_boy) [factory_boy](https://github.com/FactoryBoy/factory_boy) - A test fixtures replacement for Python.
    * <code>&nbsp;&nbsp;&nbsp;813</code> ![](https://img.shields.io/github/last-commit/klen/mixer) [mixer](https://github.com/klen/mixer) - Another fixtures replacement. Supports Django, Flask, SQLAlchemy, Peewee and etc.
    * <code>&nbsp;&nbsp;&nbsp;921</code> ![](https://img.shields.io/github/last-commit/vandersonmota/model_mommy) [model_mommy](https://github.com/vandersonmota/model_mommy) - Creating random fixtures for testing in Django.
* Code Coverage
    * [coverage](https://pypi.org/project/coverage/) - Code coverage measurement.
* Fake Data
    * <code>&nbsp;&nbsp;2129</code> ![](https://img.shields.io/github/last-commit/emirozer/fake2db) [fake2db](https://github.com/emirozer/fake2db) - Fake database generator.
    * <code>&nbsp;14029</code> ![](https://img.shields.io/github/last-commit/joke2k/faker) [faker](https://github.com/joke2k/faker) - A Python package that generates fake data.
    * <code>&nbsp;&nbsp;3559</code> ![](https://img.shields.io/github/last-commit/lk-geimfari/mimesis) [mimesis](https://github.com/lk-geimfari/mimesis) - is a Python library that help you generate fake data.
...
* General
    * <code>&nbsp;&nbsp;1688</code> ![](https://img.shields.io/github/last-commit/chardet/chardet) [chardet](https://github.com/chardet/chardet) - Python 2/3 compatible character encoding detector.
    * [difflib](https://docs.python.org/3/library/difflib.html) - (Python standard library) Helpers for computing deltas.
    * <code>&nbsp;&nbsp;3224</code> ![](https://img.shields.io/github/last-commit/LuminosoInsight/python-ftfy) [ftfy](https://github.com/LuminosoInsight/python-ftfy) - Makes Unicode text less broken and more consistent automagically.
    * <code>&nbsp;&nbsp;8645</code> ![](https://img.shields.io/github/last-commit/seatgeek/fuzzywuzzy) [fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - Fuzzy String Matching.
    * <code>&nbsp;&nbsp;1111</code> ![](https://img.shields.io/github/last-commit/ztane/python-Levenshtein) [Levenshtein](https://github.com/ztane/python-Levenshtein/) - Fast computation of Levenshtein distance and string similarity.
    * <code>&nbsp;&nbsp;&nbsp;185</code> ![](https://img.shields.io/github/last-commit/vinta/pangu.py) [pangu.py](https://github.com/vinta/pangu.py) - Paranoid text spacing.
    * <code>&nbsp;&nbsp;&nbsp;967</code> ![](https://img.shields.io/github/last-commit/pwaller/pyfiglet) [pyfiglet](https://github.com/pwaller/pyfiglet) - An implementation of figlet written in Python.
    * <code>&nbsp;&nbsp;3808</code> ![](https://img.shields.io/github/last-commit/mozillazg/python-pinyin) [pypinyin](https://github.com/mozillazg/python-pinyin) - Convert Chinese hanzi (漢字) to pinyin (拼音).
    * <code>&nbsp;&nbsp;2771</code> ![](https://img.shields.io/github/last-commit/orsinium/textdistance) [textdistance](https://github.com/orsinium/textdistance) - Compute distance between sequences with 30+ algorithms.
    * [unidecode](https://pypi.org/project/Unidecode/) - ASCII transliterations of Unicode text.
* Slugify
    * <code>&nbsp;&nbsp;&nbsp;465</code> ![](https://img.shields.io/github/last-commit/dimka665/awesome-slugify) [awesome-slugify](https://github.com/dimka665/awesome-slugify) - A Python slugify library that can preserve unicode.
    * <code>&nbsp;&nbsp;1186</code> ![](https://img.shields.io/github/last-commit/un33k/python-slugify) [python-slugify](https://github.com/un33k/python-slugify) - A Python slugify library that translates unicode to ASCII.
    * <code>&nbsp;&nbsp;&nbsp;306</code> ![](https://img.shields.io/github/last-commit/mozilla/unicode-slugify) [unicode-slugify](https://github.com/mozilla/unicode-slugify) - A slugifier that generates unicode slugs with Django as a dependency.
* Unique identifiers
    * <code>&nbsp;&nbsp;1309</code> ![](https://img.shields.io/github/last-commit/davidaurelio/hashids-python) [hashids](https://github.com/davidaurelio/hashids-python) - Implementation of [hashids](http://hashids.org) in Python.
    * <code>&nbsp;&nbsp;1634</code> ![](https://img.shields.io/github/last-commit/skorokithakis/shortuuid) [shortuuid](https://github.com/skorokithakis/shortuuid) - A generator library for concise, unambiguous and URL-safe UUIDs.
* Parser
    * <code>&nbsp;&nbsp;2170</code> ![](https://img.shields.io/github/last-commit/dabeaz/ply) [ply](https://github.com/dabeaz/ply) - Implementation of lex and yacc parsing tools for Python.
    * [pygments](http://pygments.org/) - A generic syntax highlighter.
    * <code>&nbsp;&nbsp;1469</code> ![](https://img.shields.io/github/last-commit/pyparsing/pyparsing) [pyparsing](https://github.com/pyparsing/pyparsing) - A general purpose framework for generating parsers.
    * <code>&nbsp;&nbsp;&nbsp;534</code> ![](https://img.shields.io/github/last-commit/derek73/python-nameparser) [python-nameparser](https://github.com/derek73/python-nameparser) - Parsing human names into their individual components.
    * <code>&nbsp;&nbsp;2974</code> ![](https://img.shields.io/github/last-commit/daviddrysdale/python-phonenumbers) [python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - Parsing, formatting, storing and validating international phone numbers.
    * <code>&nbsp;&nbsp;1253</code> ![](https://img.shields.io/github/last-commit/selwin/python-user-agents) [python-user-agents](https://github.com/selwin/python-user-agents) - Browser user agent parser.
    * <code>&nbsp;&nbsp;2802</code> ![](https://img.shields.io/github/last-commit/andialbrecht/sqlparse) [sqlparse](https://github.com/andialbrecht/sqlparse) - A non-validating SQL parser.

## Third-party APIs

*Libraries for accessing third party services APIs. Also see <code>&nbsp;&nbsp;1853</code> ![](https://img.shields.io/github/last-commit/realpython/list-of-python-api-wrappers) [List of Python API Wrappers and Libraries](https://github.com/realpython/list-of-python-api-wrappers).*

* [apache-libcloud](https://libcloud.apache.org/) - One Python library for all clouds.
* <code>&nbsp;&nbsp;7175</code> ![](https://img.shields.io/github/last-commit/boto/boto3) [boto3](https://github.com/boto/boto3) - Python interface to Amazon Web Services.
* <code>&nbsp;&nbsp;&nbsp;329</code> ![](https://img.shields.io/github/last-commit/istrategylabs/django-wordpress) [django-wordpress](https://github.com/istrategylabs/django-wordpress) - WordPress models and views for Django.
* <code>&nbsp;&nbsp;2638</code> ![](https://img.shields.io/github/last-commit/mobolic/facebook-sdk) [facebook-sdk](https://github.com/mobolic/facebook-sdk) - Facebook Platform Python SDK.
* <code>&nbsp;&nbsp;5575</code> ![](https://img.shields.io/github/last-commit/google/google-api-python-client) [google-api-python-client](https://github.com/google/google-api-python-client) - Google APIs Client Library for Python.
* <code>&nbsp;&nbsp;5868</code> ![](https://img.shields.io/github/last-commit/burnash/gspread) [gspread](https://github.com/burnash/gspread) - Google Spreadsheets Python API.
* <code>&nbsp;&nbsp;1828</code> ![](https://img.shields.io/github/last-commit/ryanmcgrath/twython) [twython](https://github.com/ryanmcgrath/twython) - A Python wrapper for the Twitter API.

## URL Manipulation

*Libraries for parsing URLs.*

* <code>&nbsp;&nbsp;2238</code> ![](https://img.shields.io/github/last-commit/gruns/furl) [furl](https://github.com/gruns/furl) - A small Python library that makes parsing and manipulating URLs easy.
* <code>&nbsp;&nbsp;&nbsp;273</code> ![](https://img.shields.io/github/last-commit/codeinthehole/purl) [purl](https://github.com/codeinthehole/purl) - A simple, immutable URL class with a clean API for interrogation and manipulation.
* <code>&nbsp;&nbsp;&nbsp;328</code> ![](https://img.shields.io/github/last-commit/ellisonleao/pyshorteners) [pyshorteners](https://github.com/ellisonleao/pyshorteners) - A pure Python URL shortening lib.
* <code>&nbsp;&nbsp;1256</code> ![](https://img.shields.io/github/last-commit/marshmallow-code/webargs) [webargs](https://github.com/marshmallow-code/webargs) - A friendly library for parsing HTTP request arguments with built-in support for popular web frameworks.
...
* <code>&nbsp;&nbsp;&nbsp;107</code> ![](https://img.shields.io/github/last-commit/aizvorski/scikit-video) [scikit-video](https://github.com/aizvorski/scikit-video) - Video processing routines for SciPy.
* <code>&nbsp;&nbsp;2177</code> ![](https://img.shields.io/github/last-commit/abhiTronix/vidgear) [vidgear](https://github.com/abhiTronix/vidgear) - Most Powerful multi-threaded Video Processing framework.

## Web Asset Management

*Tools for managing, compressing and minifying website assets.*

* <code>&nbsp;&nbsp;2559</code> ![](https://img.shields.io/github/last-commit/django-compressor/django-compressor) [django-compressor](https://github.com/django-compressor/django-compressor) - Compresses linked and inline JavaScript or CSS into a single cached file.
* <code>&nbsp;&nbsp;1432</code> ![](https://img.shields.io/github/last-commit/jazzband/django-pipeline) [django-pipeline](https://github.com/jazzband/django-pipeline) - An asset packaging library for Django.
* <code>&nbsp;&nbsp;2138</code> ![](https://img.shields.io/github/last-commit/jschneier/django-storages) [django-storages](https://github.com/jschneier/django-storages) - A collection of custom storage back ends for Django.
* [fanstatic](http://www.fanstatic.org/en/latest/) - Packages, optimizes, and serves static file dependencies as Python packages.
* [fileconveyor](http://wimleers.com/fileconveyor) - A daemon to detect and sync files to CDNs, S3 and FTP.
* <code>&nbsp;&nbsp;&nbsp;425</code> ![](https://img.shields.io/github/last-commit/miracle2k/flask-assets) [flask-assets](https://github.com/miracle2k/flask-assets) - Helps you integrate webassets into your Flask app.
* <code>&nbsp;&nbsp;&nbsp;906</code> ![](https://img.shields.io/github/last-commit/miracle2k/webassets) [webassets](https://github.com/miracle2k/webassets) - Bundles, optimizes, and manages unique cache-busting URLs for static resources.

## Web Content Extracting

*Libraries for extracting web contents.*

* <code>&nbsp;&nbsp;1247</code> ![](https://img.shields.io/github/last-commit/Alir3z4/html2text) [html2text](https://github.com/Alir3z4/html2text) - Convert HTML to Markdown-formatted text.
* <code>&nbsp;&nbsp;&nbsp;553</code> ![](https://img.shields.io/github/last-commit/michaelhelmick/lassie) [lassie](https://github.com/michaelhelmick/lassie) - Web Content Retrieval for Humans.
* <code>&nbsp;&nbsp;&nbsp;568</code> ![](https://img.shields.io/github/last-commit/coleifer/micawber) [micawber](https://github.com/coleifer/micawber) - A small library for extracting rich content from URLs.
* <code>&nbsp;11786</code> ![](https://img.shields.io/github/last-commit/codelucas/newspaper) [newspaper](https://github.com/codelucas/newspaper) - News extraction, article extraction and content curation in Python.
* <code>&nbsp;&nbsp;2102</code> ![](https://img.shields.io/github/last-commit/buriy/python-readability) [python-readability](https://github.com/buriy/python-readability) - Fast Python port of arc90's readability tool.
* <code>&nbsp;12466</code> ![](https://img.shields.io/github/last-commit/psf/requests-html) [requests-html](https://github.com/psf/requests-html) - Pythonic HTML Parsing for Humans.
* <code>&nbsp;&nbsp;2784</code> ![](https://img.shields.io/github/last-commit/miso-belica/sumy) [sumy](https://github.com/miso-belica/sumy) - A module for automatic summarization of text documents and HTML pages.
* <code>&nbsp;&nbsp;3240</code> ![](https://img.shields.io/github/last-commit/deanmalmgren/textract) [textract](https://github.com/deanmalmgren/textract) - Extract text from any document, Word, PowerPoint, PDFs, etc.
* <code>&nbsp;&nbsp;3250</code> ![](https://img.shields.io/github/last-commit/gaojiuli/toapi) [toapi](https://github.com/gaojiuli/toapi) - Every web site provides APIs.

## Web Crawling

*Libraries to automate web scraping.*

* <code>&nbsp;&nbsp;1434</code> ![](https://img.shields.io/github/last-commit/chineking/cola) [cola](https://github.com/chineking/cola) - A distributed crawling framework.
* [feedparser](https://pythonhosted.org/feedparser/) - Universal feed parser.
* <code>&nbsp;&nbsp;2180</code> ![](https://img.shields.io/github/last-commit/lorien/grab) [grab](https://github.com/lorien/grab) - Site scraping framework.
* <code>&nbsp;&nbsp;3921</code> ![](https://img.shields.io/github/last-commit/MechanicalSoup/MechanicalSoup) [MechanicalSoup](https://github.com/MechanicalSoup/MechanicalSoup) - A Python library for automating interaction with websites.
* <code>&nbsp;&nbsp;8456</code> ![](https://img.shields.io/github/last-commit/scrapinghub/portia) [portia](https://github.com/scrapinghub/portia) - Visual scraping for Scrapy.
* <code>&nbsp;15382</code> ![](https://img.shields.io/github/last-commit/binux/pyspider) [pyspider](https://github.com/binux/pyspider) - A powerful spider system.
* <code>&nbsp;&nbsp;3591</code> ![](https://img.shields.io/github/last-commit/jmcarp/robobrowser) [robobrowser](https://github.com/jmcarp/robobrowser) - A simple, Pythonic library for browsing the web without a standalone web browser.
* [scrapy](https://scrapy.org/) - A fast high-level screen scraping and web crawling framework.

## Web Frameworks

*Traditional full stack web frameworks. Also see <code>123934</code> ![](https://img.shields.io/github/last-commit/vinta/awesome-python#restful-api) [RESTful API](https://github.com/vinta/awesome-python#restful-api).*

* Synchronous
    * [Django](https://www.djangoproject.com/) - The most popular web framework in Python.
        * <code>&nbsp;&nbsp;&nbsp;769</code> ![](https://img.shields.io/github/last-commit/shahraizali/awesome-django) [awesome-django](https://github.com/shahraizali/awesome-django)
        * <code>&nbsp;&nbsp;5252</code> ![](https://img.shields.io/github/last-commit/wsvincent/awesome-django) [awesome-django](https://github.com/wsvincent/awesome-django)
    * [Flask](http://flask.pocoo.org/) - A microframework for Python.
        * <code>&nbsp;10534</code> ![](https://img.shields.io/github/last-commit/humiaozuzu/awesome-flask) [awesome-flask](https://github.com/humiaozuzu/awesome-flask)
    * [Pyramid](https://pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
        * <code>&nbsp;&nbsp;&nbsp;522</code> ![](https://img.shields.io/github/last-commit/uralbash/awesome-pyramid) [awesome-pyramid](https://github.com/uralbash/awesome-pyramid)
    * <code>&nbsp;&nbsp;1750</code> ![](https://img.shields.io/github/last-commit/MasoniteFramework/masonite) [Masonite](https://github.com/MasoniteFramework/masonite) - The modern and developer centric Python web framework.
* Asynchronous
...
* <code>&nbsp;&nbsp;2332</code> ![](https://img.shields.io/github/last-commit/crossbario/autobahn-python) [autobahn-python](https://github.com/crossbario/autobahn-python) - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* <code>&nbsp;&nbsp;5242</code> ![](https://img.shields.io/github/last-commit/django/channels) [channels](https://github.com/django/channels) - Developer-friendly asynchrony for Django.
* <code>&nbsp;&nbsp;3885</code> ![](https://img.shields.io/github/last-commit/aaugustin/websockets) [websockets](https://github.com/aaugustin/websockets) - A library for building WebSocket servers and clients with a focus on correctness and simplicity.

## WSGI Servers

*WSGI-compatible web servers.*

* <code>&nbsp;&nbsp;2757</code> ![](https://img.shields.io/github/last-commit/jonashaag/bjoern) [bjoern](https://github.com/jonashaag/bjoern) - Asynchronous, very fast and written in C.
* <code>&nbsp;&nbsp;8257</code> ![](https://img.shields.io/github/last-commit/benoitc/gunicorn) [gunicorn](https://github.com/benoitc/gunicorn) - Pre-forked, ported from Ruby's Unicorn project.
* [uWSGI](https://uwsgi-docs.readthedocs.io/en/latest/) - A project aims at developing a full stack for building hosting services, written in C.
* <code>&nbsp;&nbsp;1056</code> ![](https://img.shields.io/github/last-commit/Pylons/waitress) [waitress](https://github.com/Pylons/waitress) - Multi-threaded, powers Pyramid.
* <code>&nbsp;&nbsp;6036</code> ![](https://img.shields.io/github/last-commit/pallets/werkzeug) [werkzeug](https://github.com/pallets/werkzeug) - A WSGI utility library for Python that powers Flask and can easily be embedded into your own projects.
...
* Tutorials
    ...
    * <code>&nbsp;&nbsp;3525</code> ![](https://img.shields.io/github/last-commit/huangsam/ultimate-python) [Ultimate Python study guide](https://github.com/huangsam/ultimate-python)
* Libraries
    * [Awesome Python @LibHunt](https://python.libhunt.com/)
* Others
    * [Python ZEEF](https://python.zeef.com/alan.richmond)
    * [Pythonic News](https://news.python.sc/)
    * <code>&nbsp;28545</code> ![](https://img.shields.io/github/last-commit/satwikkansal/wtfpython) [What the f*ck Python!](https://github.com/satwikkansal/wtfpython)
...
Your contributions are always welcome! Please take a look at the <code>123934</code> ![](https://img.shields.io/github/last-commit/vinta/awesome-python) [contribution guidelines](https://github.com/vinta/awesome-python/blob/master/CONTRIBUTING.md) first.

I will keep some pull requests open if I'm not sure whether those libraries are awesome, you could <code>123934</code> ![](https://img.shields.io/github/last-commit/vinta/awesome-python) [vote for them](https://github.com/vinta/awesome-python/pulls) by adding :+1: to them. Pull requests will be merged when their votes reach **20**.
